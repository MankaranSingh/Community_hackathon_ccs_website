...
from wtforms import StringField, SubmitField, BooleanField , PasswordField, SubmitField, ValidationError,IntegerField,TextAreaField
...
class SignUp_society(FlaskForm):
    ...
    Submit = SubmitField('Link Society')
...
class Account_form(FlaskForm):
    ...
    username = StringField('Username: *(Not Changeable)' , validators= [Length(3,50), DataRequired()])
    email = StringField('Email: *(Not Changeable) ', validators= [Email(), DataRequired()])
    phone_number = IntegerField('Contact Number: ', validators=[DataRequired()])
    year = IntegerField('Year: ', validators=[DataRequired()])
    roll_number = IntegerField('Roll Number: ', validators= [DataRequired()])
...
class Post_form(FlaskForm):
    society_name = StringField('Society Name:', validators = [DataRequired(), Length(1,100)])
    post_title = StringField('Title:', validators = [DataRequired(), Length(1,100)])
    post_body = TextAreaField('Post Body:', validators = [DataRequired(), Length(1,1000)])
